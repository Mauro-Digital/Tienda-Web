...
var data = {
    productos: [
        ...
        },
        {
            ...
            descripcion: 'Consectetur adipisicing.',
            precio: 450.0,
            colores: ['negro', 'rojo', 'amarillo'],
            tamaño: ['1,5', '2', '2,5', '3', '4'],
        },
...
let carrito = [];
const formatearMoneda = new Intl.NumberFormat('es-MX', {style: 'currency', currency: 'MXM'});
const notificacion = document.getElementById('notificacion');

const renderCarrito = () => {
    ventanaCarrito.classList.add('carrito--active');

    // Eliminamos todos los productos anteriores para construir al carrito desde cero.
    const productosAnteriores = ventanaCarrito.querySelectorAll('.carrito__producto');
    productosAnteriores.forEach((producto) => producto.remove());

    let total = 0;

    // Comprobamos si hay carritos
    if(carrito.length < 1){
        ...
        // Obtenemos el precio del archivo de productos.js
